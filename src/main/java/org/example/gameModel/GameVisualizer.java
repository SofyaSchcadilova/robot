...
public class GameVisualizer extends JPanel implements PropertyChangeListener
{
    ...
    public GameVisualizer(GameController gameController){
        addMouseListener(new MouseAdapter()
        {
            ...
            {
                gameController.setCoordinates(e.getPoint());
                repaint();
            }
        });
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        direction = gameModel.get_robotDirection();
        robotX = gameModel.get_robotPositionX();
        robotY = gameModel.get_robotPositionY();
        targetX = gameModel.get_targetPositionX();
        targetY = gameModel.get_targetPositionY();
        onRedrawEvent();
    }
